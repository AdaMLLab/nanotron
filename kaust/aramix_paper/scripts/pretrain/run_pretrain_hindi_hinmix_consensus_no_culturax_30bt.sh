...
CONFIG="config_llama_1.46B_hinmix_consensus_no_culturax.yaml"
CKPT_DIR="hinmix_consensus_no_culturax_30bt"

echo "============================================================"
echo "Training: Llama 1.46B on HinMix Consensus (No CulturaX-only pairs, 30BT)"
