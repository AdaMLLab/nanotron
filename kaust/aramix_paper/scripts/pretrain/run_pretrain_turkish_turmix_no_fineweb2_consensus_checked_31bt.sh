...
CONFIG="config_llama_1.46B_turmix_no_fineweb2_consensus_checked_turkish.yaml"
CKPT_DIR="turmix_minhash_no_fineweb2_consensus_checked_31bt"

echo "============================================================"
echo "Training: Llama 1.46B on TurMix No FineWeb-2 Consensus Checked (31BT)"
