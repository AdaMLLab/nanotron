...
declare -A DATASETS=(
    # HinMix simple (31B tokens, proportional sampling)
    ["hinmix_minhash"]="$HOME/data/hinmix-minhash-deduped-31bt/data/sampled|hinmix-minhash-deduped-31bt|32"
    # HinMix with CulturaX consensus-checked (CulturaX docs kept only if in consensus)
    ["hinmix_no_culturax_consensus_checked"]="$HOME/data/hinmix-minhash-no_culturax_consensus_checked-31bt/data/sampled|hinmix-minhash-no_culturax_consensus_checked-31bt|32"
)
