...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/itamix_no_fw2_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/itamix_no_fw2_%j.err
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/itamix_no_fw2"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_itamix_no_fw2.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_italian/config_llama_1.46B_itamix_no_fw2.yaml"

DATA_BASE="/mnt/data/u/alrashsm"
RAW_SRC="${DATA_BASE}/datasets/itamix-matched/consensus"
FILTERED_DIR="${DATA_BASE}/datasets/itamix-matched-no_fw2/consensus"
TOKENIZED_DIR="${DATA_BASE}/nanotron_checkpoints/tokenized_data/itamix-matched-no_fw2"
