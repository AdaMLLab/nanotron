...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/turmix_dup4_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/turmix_dup4_%j.err
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/turmix_dup4"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_turmix_dup4.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_turkish/config_llama_1.46B_turmix_dup4.yaml"

DATA_BASE="/mnt/data/u/alrashsm"
RAW_SRC="${DATA_BASE}/datasets/turmix-matched/consensus"
FILTERED_DIR="${DATA_BASE}/datasets/turmix-matched-4/consensus"
TOKENIZED_DIR="${DATA_BASE}/nanotron_checkpoints/tokenized_data/turmix-matched-dup4"

mkdir -p "${DATA_BASE}/nanotron_checkpoints/turmix_dup4"
mkdir -p "${DATA_BASE}/nanotron_checkpoints/logs"

export CUDA_DEVICE_MAX_CONNECTIONS=1
export OMP_NUM_THREADS=4

echo "=== Training: turmix dup>=4 ==="
...
echo ""
echo "=== Filter step ==="
python "${SCRIPTS_DIR}/filter_source_count.py" "${RAW_SRC}" "${FILTERED_DIR}" 4
