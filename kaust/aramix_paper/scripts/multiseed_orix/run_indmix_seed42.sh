...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/indmix_seed42_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/indmix_seed42_%j.err
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/indmix_seed42"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_indmix_seed42.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_indonesian/config_llama_1.46B_indmix_seed42.yaml"

mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/indmix_seed42
mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/logs

export CUDA_DEVICE_MAX_CONNECTIONS=1
export OMP_NUM_THREADS=4

echo "=== Training: indmix seed42 ==="
...
tokenize_dataset \
    "/mnt/data/u/alrashsm/datasets/indmix-matched/consensus" \
    "/mnt/data/u/alrashsm/nanotron_checkpoints/tokenized_data/indmix-matched" \
    "indmix-matched" "hf" "text"
