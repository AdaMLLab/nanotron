...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/jpnmix_no_fw2_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/jpnmix_no_fw2_%j.err
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/jpnmix_no_fw2"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_jpnmix_no_fw2.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_japanese/config_llama_1.46B_jpnmix_no_fw2.yaml"

DATA_BASE="/mnt/data/u/alrashsm"
RAW_SRC="${DATA_BASE}/datasets/jpnmix-matched/consensus"
FILTERED_DIR="${DATA_BASE}/datasets/jpnmix-matched-no_fw2/consensus"
TOKENIZED_DIR="${DATA_BASE}/nanotron_checkpoints/tokenized_data/jpnmix-matched-no_fw2"
...
echo "=== Training: itamix without fineweb2 sources ==="
echo "    Config: ${CONFIG_PATH}"
echo "    Node: $(hostname)"

# --- Filter: keep rows where 'fineweb2' is NOT in source ---
echo ""
echo "=== Filter step ==="
python "${SCRIPTS_DIR}/filter_no_source.py" "${RAW_SRC}" "${FILTERED_DIR}" "fineweb2"
