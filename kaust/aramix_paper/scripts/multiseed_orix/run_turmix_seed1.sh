...
#SBATCH --requeue
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/turmix_seed1_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/turmix_seed1_%j.err
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_turkish/config_llama_1.46B_turmix_seed1.yaml"

mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/turmix_seed1
mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/logs

export CUDA_DEVICE_MAX_CONNECTIONS=1
export OMP_NUM_THREADS=4

echo "=== Training: turmix seed1 ==="
