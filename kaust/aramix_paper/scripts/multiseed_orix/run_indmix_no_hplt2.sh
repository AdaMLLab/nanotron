...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/indmix_no_hplt2_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/indmix_no_hplt2_%j.err
...
# CHAIN_MODE_UPDATED v3 — do not remove this marker
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/indmix_no_hplt2"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_indmix_no_hplt2.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_indonesian/config_llama_1.46B_indmix_no_hplt2.yaml"

DATA_BASE="/mnt/data/u/alrashsm"
RAW_SRC="${DATA_BASE}/datasets/indmix-matched/consensus"
FILTERED_DIR="${DATA_BASE}/datasets/indmix-matched-no_hplt2/consensus"
TOKENIZED_DIR="${DATA_BASE}/nanotron_checkpoints/tokenized_data/indmix-matched-no_hplt2"
...
echo "=== Training: indmix without hplt2 sources ==="
echo "    Config: ${CONFIG_PATH}"
echo "    Node: $(hostname)"

# --- Filter: keep rows where 'hplt2' is NOT in source ---
echo ""
echo "=== Filter step ==="
python "${SCRIPTS_DIR}/filter_no_source.py" "${RAW_SRC}" "${FILTERED_DIR}" "hplt2"
...
tokenize_dataset \
    "${FILTERED_DIR}" \
    "${TOKENIZED_DIR}" \
    "indmix-matched-no_hplt2" "hf" "text"
