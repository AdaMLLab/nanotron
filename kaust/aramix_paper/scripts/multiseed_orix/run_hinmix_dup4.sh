...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/hinmix_dup4_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/hinmix_dup4_%j.err
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/hinmix_dup4"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_hinmix_dup4.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_hindi/config_llama_1.46B_hinmix_dup4.yaml"

DATA_BASE="/mnt/data/u/alrashsm"
RAW_SRC="${DATA_BASE}/datasets/hinmix-matched/consensus"
FILTERED_DIR="${DATA_BASE}/datasets/hinmix-matched-4/consensus"
TOKENIZED_DIR="${DATA_BASE}/nanotron_checkpoints/tokenized_data/hinmix-matched-dup4"

mkdir -p "${DATA_BASE}/nanotron_checkpoints/hinmix_dup4"
mkdir -p "${DATA_BASE}/nanotron_checkpoints/logs"

export CUDA_DEVICE_MAX_CONNECTIONS=1
export OMP_NUM_THREADS=4

echo "=== Training: hinmix dup>=4 ==="
