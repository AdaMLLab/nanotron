...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/itamix_seed2_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/itamix_seed2_%j.err
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/itamix_seed2"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_itamix_seed2.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_italian/config_llama_1.46B_itamix_seed2.yaml"

mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/itamix_seed2
mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/logs

export CUDA_DEVICE_MAX_CONNECTIONS=1
export OMP_NUM_THREADS=4

echo "=== Training: itamix seed2 ==="
