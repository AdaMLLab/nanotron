...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/fineweb2_italian_seed42_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/fineweb2_italian_seed42_%j.err
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/fineweb2_italian_seed42"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_fineweb2_italian_seed42.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_italian/config_llama_1.46B_fineweb2_italian_seed42.yaml"

mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/fineweb2_italian_seed42
mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/logs

export CUDA_DEVICE_MAX_CONNECTIONS=1
export OMP_NUM_THREADS=4

echo "=== Training: fineweb2-italian seed42 ==="
...
tokenize_dataset \
    "/mnt/data/u/alrashsm/datasets/fineweb2-italian-40bt/data/ita_Latn/train" \
    "/mnt/data/u/alrashsm/nanotron_checkpoints/tokenized_data/fineweb2-italian-40bt" \
    "fineweb2-italian-40bt" "hf" "text"
