...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/jpnmix_seed42_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/jpnmix_seed42_%j.err
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/jpnmix_seed42"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_jpnmix_seed42.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_japanese/config_llama_1.46B_jpnmix_seed42.yaml"

mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/jpnmix_seed42
mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/logs

export CUDA_DEVICE_MAX_CONNECTIONS=1
export OMP_NUM_THREADS=4

echo "=== Training: itamix seed42 ==="
...
tokenize_dataset \
    "/mnt/data/u/alrashsm/datasets/jpnmix-matched/consensus" \
    "/mnt/data/u/alrashsm/nanotron_checkpoints/tokenized_data/jpnmix-matched" \
    "jpnmix-matched" "hf" "text"
