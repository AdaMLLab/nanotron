...
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/itamix_seed42_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/itamix_seed42_%j.err
...
_CKPT_DIR="/mnt/data/u/alrashsm/nanotron_checkpoints/itamix_seed42"
_TRAIN_STEPS=14000
_SELF_SCRIPT="/home/alrashsm/github/nanotron/kaust/aramix_paper/scripts/multiseed_orix/run_itamix_seed42.sh"
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_italian/config_llama_1.46B_itamix_seed42.yaml"

mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/itamix_seed42
...
tokenize_dataset \
    "/mnt/data/u/alrashsm/datasets/itamix-matched/consensus" \
    "/mnt/data/u/alrashsm/nanotron_checkpoints/tokenized_data/itamix-matched" \
    "itamix-matched" "hf" "text"
