...
#SBATCH --requeue
#SBATCH --output=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/consensus_seed2_%j.out
#SBATCH --error=/mnt/data/u/alrashsm/nanotron_checkpoints/logs/consensus_seed2_%j.err
...
CONFIG_PATH="${NANOTRON_DIR}/kaust/aramix_paper/configs/multiseed_aramix/config_llama_1.46B_consensus_seed2.yaml"

mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/consensus_seed2
mkdir -p /mnt/data/u/alrashsm/nanotron_checkpoints/logs

export CUDA_DEVICE_MAX_CONNECTIONS=1
export OMP_NUM_THREADS=4

echo "=== Multi-Seed Training: consensus seed2 ==="
