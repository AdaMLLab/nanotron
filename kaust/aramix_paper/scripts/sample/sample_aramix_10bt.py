#!/usr/bin/env python3
"""Sample ~10B tokens from Aramix MinHash deduped dataset with target source ratios."""
...
TARGET_RATIOS = {
    "CulturaX": 23.7, "ArabicWeb24": 19.9, "HPLT 2.0": 19.5,
    "FineWeb-2": 15.4, "C4": 12.6, "101B Arabic Words": 5.3, "FinePDFs": 3.5,
}

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--input-dir", default="~/data/pretraining_data/aramix-minhash-deduped")
    parser.add_argument("--output-dir", default="~/data/aramix-minhash-deduped-10bt/")
