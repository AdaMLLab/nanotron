#!/usr/bin/env python3
"""Sample ~30B tokens from Aramix MinHash, keeping ArabicWeb24 docs only if they appear in consensus."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--consensus-dir", default="~/data/aramix_paper/aramix-consensus")
    parser.add_argument("--output-dir", default="~/data/aramix_paper/aramix-minhash-no_aw24_consensus_checked-30bt")
    ...
    avg_tokens, doc_counts = estimate_tokens_per_source(
        ...
        consensus_hashes=consensus_hashes, consensus_source="ArabicWeb24",
    ...
    sample_and_save(args.input_dir, args.output_dir, plan, SOURCE_MAPPING, tokenizer,
                    consensus_hashes=consensus_hashes, consensus_source="ArabicWeb24", seed=args.seed)
