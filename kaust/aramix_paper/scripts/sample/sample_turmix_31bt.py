...
def sample_and_save(
    ...
    with open(summary_path, "w") as f:
        f.write("TurMix 31B Token Sample Summary\n")
        f.write("=" * 50 + "\n\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="Sample ~31B tokens from TurMix dataset with proportional source ratios"
    )
    parser.add_argument(
        "--input-dir",
        type=str,
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="~/data/turmix-minhash-deduped-31bt/",
    ...
    print("=" * 60)
    print("TurMix 31B Token Sampler")
    print("=" * 60)
