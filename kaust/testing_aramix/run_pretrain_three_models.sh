#!/bin/bash
#
# Train THREE SEPARATE LLaMA 1.46B models back-to-back:
#
#   Model 1: Trained on FineWeb-Edu Arabic (~30B tokens)
...
#
#   Model 3: Trained on FinePDFs Arabic
...
echo "############################################################"
echo "#                                                          #"
echo "#  LLaMA 1.46B - Train Three Separate Models               #"
echo "#                                                          #"
echo "############################################################"
echo ""
echo "This script trains THREE INDEPENDENT models back-to-back:"
echo ""
echo "  Model 1: FineWeb-Edu Arabic"
echo "           - Tokens: ~30B"
...
echo ""
echo "============================================================"
echo "[Model 1/3] Training on FineWeb-Edu Arabic"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "[Model 1/3] COMPLETE - FineWeb-Edu Arabic model trained!"
...
echo ""
echo "============================================================"
echo "[Model 2/3] Training on ArabicWeb24 (starting fresh)"
echo "============================================================"
echo "Start time: $(date)"
echo "Checkpoints: ${CHECKPOINTS_DIR}/checkpoints_arabicweb24/"
echo ""
...
echo ""
echo "============================================================"
echo "[Model 2/3] COMPLETE - ArabicWeb24 model trained!"
...
echo ""
echo "============================================================"
echo "[Model 3/3] Training on FinePDFs Arabic (starting fresh)"
echo "============================================================"
echo "Start time: $(date)"
echo "Checkpoints: ${CHECKPOINTS_DIR}/checkpoints_finepdfs_arabic/"
echo ""
...
END_TIME=$(date +%s)
MODEL3_DURATION=$((END_TIME - MODEL2_END_TIME))
TOTAL_DURATION=$((END_TIME - START_TIME))

echo ""
echo "############################################################"
echo "#                                                          #"
echo "#  All Three Models Trained Successfully!                  #"
echo "#                                                          #"
echo "############################################################"
echo ""
echo "Summary:"
