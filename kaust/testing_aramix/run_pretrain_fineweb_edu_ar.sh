#!/bin/bash
#
# Full pretraining run for LLaMA 1.46B on FineWeb-Edu Arabic dataset
#
# Training configuration (~30B tokens):
#   - Total tokens: ~30B (14,000 steps x 2,097,152 tokens/step)
...
#
# Prerequisites:
#   - Run run_sample.sh first to sample ~30B tokens
#   - Run run_tokenize.sh to tokenize the sampled data
#
...
CONFIG_FILE="${SCRIPT_DIR}/config_llama_1.46B_fineweb_edu_ar.yaml"
...
mkdir -p "/home/alrashsm/github/nanotron/kaust/checkpoints/checkpoints_fineweb_edu_ar_30bt"

echo "=========================================="
echo "LLaMA 1.46B Pretraining - FineWeb-Edu Arabic"
echo "=========================================="
