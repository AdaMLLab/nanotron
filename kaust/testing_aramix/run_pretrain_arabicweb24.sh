#!/bin/bash
#
# Full pretraining run for LLaMA 1.46B on ArabicWeb24 dataset
#
# Training configuration (~29B tokens):
#   - Total tokens: ~29.3B (14,000 steps x 2,097,152 tokens/step)
...
#   - Documents: ~39M
#   - Tokens: ~29.3B (pre-computed using gemma tokenizer)
#

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CONFIG_FILE="${SCRIPT_DIR}/config_llama_1.46B_arabicweb24.yaml"
...
mkdir -p "${SCRIPT_DIR}/checkpoints_arabicweb24"

echo "=========================================="
echo "LLaMA 1.46B Pretraining - ArabicWeb24"
echo "=========================================="
